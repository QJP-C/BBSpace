...
import com.be.bang.common.Constants;
...
public class SendSmsUtil {
    ...
    public static boolean addSendSms(String PhoneNumbers, Map code) {
        DefaultProfile profile = DefaultProfile.getProfile(Constants.SEND_REGIONLD, Constants.SEND_ACCESSKEYLD, Constants.SEND_SECRET);
...
//        request.setVersion("V1.0");
        ...
        request.putQueryParameter("TemplateCode", Constants.SEND_TEMPLATECODE); //自己配置的模板 模版CODE
